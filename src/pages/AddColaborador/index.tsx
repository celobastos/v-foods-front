        ...
        <div className="flex items-center justify-center mt-2">
          <div className="w-full max-w-md bg-white p-11 rounded-3xl border border-gray-300 ">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto">
              ...
              <div className="mb-4">
                <label htmlFor="address" className="block text-sm font-medium text-gray-700"></label>
                <input
                  type="text"
                  id="address"
                  name="address"
              ...
              <div className="mb-4">
                <label htmlFor="CEP" className="block text-sm font-medium text-gray-700"></label>
                <input
                  type="text"
                  id="CEP"
                  name="CEP"
